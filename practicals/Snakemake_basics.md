---
title: "Snakemake An example workflow"
author: "Igor Ruiz de los Mozos"
output:
  pdf_document: default
  html_document: default
---
# Basics: An example workflow {#tutorial-basics}
...
reference genome (see `tutorial-background`{.interpreted-text
role="ref"}). For this, we will use the tool
...
integrated development environment (IDE) tool [Visual Studio
Code](https://code.visualstudio.com/), since it provides a good syntax
highlighting [Snakemake
extension](https://marketplace.visualstudio.com/items?itemName=Snakemake.snakemake-lang)
and a [remote
extension](https://marketplace.visualstudio.com/items?itemName=ms-vscode.remote-explorer)
for directly using the IDE on a remote server. In the Snakefile, define
the following rule:
...
## Step 6: Using custom scripts {#tutorial-script}
...
In case you have multiple reasonable sets of target files, you can add
