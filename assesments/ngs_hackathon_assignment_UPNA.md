...
- Compare **alignment rate**, **error rate**, and **multimapping or secondary reads** using `samtools` and `multiQC`.  
- Reflect on the trade-off between **alignment rate** (quantity) and **alignment accuracy** (quality) and **error rate** (quality).  
...
> 
> # Cutadapt trimming
> cutadapt -parameter ¿¿¿¿¿ -parameter ¿¿¿¿¿ -parameter ¿¿¿¿¿ -parameter ¿¿¿¿¿¿¿?????? 
> 
> # Bowtie2 alignment
> bowtie2 -x reference_genome -1 BQ_trimmed_R1.fastq -2 BQ_trimmed_R2.fastq \
>   ¿¿¿¿¿ -parameter ?????? -S BQ_aligned_tried?.sam
> 
> ```
