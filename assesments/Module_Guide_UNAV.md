...
|------|-----------|----------|-------------|
| **Mar 6th 23:59h** | — | **Assessment 1 Submission Window** | Upload the NGS Hackathon report (Markdown → PDF) via ADI for grading. |
...
| **Mar 24th 8:00h** | ADI | **Assessment 2 PDF Submission Deadline** | Upload the Final Coursework package (Task 1/2/3/4) as a PDF or HTML export with embedded code and figures. |
